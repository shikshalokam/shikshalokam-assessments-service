    ...
    static findSubmission(document) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                return resolve({
                    message: apiResponses.FOUND_SUBMISSION,
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                if(observationId == "" || entityId == "") {
                    throw new Error(apiResponses.INVALID_OBSERVATION_ENTITY_ID);
                }
                ...
                return resolve({
                    success: true,
                    message: apiResponses.SUBMISSION_NUMBER_FETCHED,
    ...
    static sendUserNotifications(userId = "", observationData = {}) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                return resolve({
                    success: true,
                    message: apiResponses.NOTIFICATION_PUSHED_TO_KAFKA
                })
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if (!observationDocuments.length > 0) {
                    throw apiResponses.NO_PENDING_COMPLETED_OBSERVATIONS;
                }
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if(!observationDocument[0]) {
                    throw new Error(apiResponses.OBSERVATION_NOT_FOUND);
                }
