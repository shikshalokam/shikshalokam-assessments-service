        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                await observationSubmissionsHelper.observationSubmissionsDocument({
                    ...
                    solutionId : { $in : observationSolutions },
...
function _observationSubmissionInformation(submissions,solutionId,entityId) {
    return {
        totalSubmissionCount : 
        submissions[solutionId] && submissions[solutionId][entityId].submissions.length > 0 ? 
